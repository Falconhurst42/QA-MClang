...
public:
    ...
    /**
     * @brief get a list of variables that are not global variables
     * @return The list as a vector of Vars
     * @note This is the same as `getVars` but with the first entry on the stack
     * removed
     */
    std::vector<Var> getNonGlobalVars() const;

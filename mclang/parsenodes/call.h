...
private:
     ...
     * @param man The main bytecode manager
     */
    void pushLocalVars(BCManager &man);

    /**
     * Retrieve local variables from the stack
     * @param man The main bytecode manager
     */
    void popLocalVars(BCManager &man);
    ...
    // Holds the names of the temporary variables that have been put on the
    // stack, in the order they have been put in the stack

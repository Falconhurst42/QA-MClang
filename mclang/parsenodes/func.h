...
private:
    ...
    /**
     * Get the formatted name of this function, with every uppcase character
     * replaced by a dot following its lowercase variant
     */
    std::string getFormattedName() const;

    /**
     * Check for non-void function without a return statement in the main
     * function body
     * @param man The main bytecode manager
     */
    void checkReturnWarning(BCManager &man) const;

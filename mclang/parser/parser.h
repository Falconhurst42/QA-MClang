...
private:
    ...
    /**
     * Read in a loop, which is either a while loop or a for loop
     * @return A pointer to the generated parse node
     */
    ParseNode *readInLoop();
    ...
    /**
     * Read in a comma-expression
     * @return A pointer to the generated parse node
     */
    ParseNode *readInComma();
    ...
    /**
     * Read in a return statement
     * @return A pointer to the generated parse node
     */
    ParseNode *readInReturn();
    ...
    /**
     * Check if any type of assignment token is currently being read
     * @param ptype The parse node type to use will be output here
     * @return A boolean indicating if an assignment token is currently being
     * read
     */
    bool acceptAssign(ParseNodeType &ptype) const;
